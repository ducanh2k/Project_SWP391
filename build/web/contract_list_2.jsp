                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary filterable">
                                <div class="mb-4 d-flex justify-content-between align-items-center">
                                    <h2>Contract List</h2>
                                    <a role="button" href="Controller_Contract?service=add_contract" class="font-weight-bold">ADD NEW</a>
                                </div>
                                ...
                                <table class="table" id="myTable">
                                    <thead>
                                        <tr class="filters">
                                            ...
                                            <th><input type="text" class="form-control" disabled>Contract Type</th>
