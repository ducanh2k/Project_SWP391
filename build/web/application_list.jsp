<%-- 
    ...
    Created on : Oct 20, 2022, 11:34:34 PM
    Author     : Admin
--%>
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary filterable">
                                <div class="mb-4 d-flex justify-content-between align-items-center">
                                    ...
                                    <a role="button" href="create_application.jsp" class="font-weight-bold">ADD NEW</a>
                                </div>
                                ...
                                <table class="table" id="myTable">
                                    <thead>
                                        <tr class="filters">
                                            ...
                                            <th><input type="text" class="form-control" disabled>Employee Name</th>
                                            <th><input type="text" class="form-control" disabled>Employee ID</th>
        ...
        <script>
                            ...
                            for (var i = 0; i < tables.length; i++)
                            {
                                ...
                                s = s.replace('Approved', '<span style="color:green">Approved</span>');
                                s = s.replace('Processing', '<span style="color:orange">Processing</span>');
                                s = s.replace('Refused', '<span style="color:red">Refused</span>');
