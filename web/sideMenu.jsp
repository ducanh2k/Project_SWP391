        ...
        <nav class="nav">
            <div> <a href="main.jsp" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i><span class="nav_logo-name">HRM</span></a>
                <div class="nav_list"> 
                    ...
                    %>
                    <a href="attendant" class="nav_link"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Attendance</span> </a> 
                    <%
                        }
                    %>
                    <a href="ApplicationList" class="nav_link"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Application</span> </a>
                    <a href="login?service=logout" class="nav_link"> <i class='bx bx-log-out nav_icon'></i> <span class="nav_name">Log out</span> </a>
                </div>
            </div>
        </nav>
    </div>
