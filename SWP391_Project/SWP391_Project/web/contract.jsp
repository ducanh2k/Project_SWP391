                    ...
                    <div class="card-body">
                        ...
                        <form action="contract" method="POST">
                            ...
                            <div class="row row-space">
                                <div class="input-group">
                                    <input class="input--style-2" type="number" placeholder="EmployeeID" name="eid" required>
                                </div>
                                <div class="input-group">
                                    <input class="input--style-2" type="number" placeholder=" DepartmentID" name="did"required>
                                </div>
                            </div>
                            <div class="row row-space">
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="input-group">
                                        <input class="input--style-2 js-datepicker" type="text" placeholder="End Date" name="end" required>
                                        <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                    </div>
                                </div>
                            ...
                            <div class="input-group">
                                <div class="rs-select2 js-select-simple select--no-search">
                                    <select name="workingTime" required>
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        <input readonly class="input--style-2" type="text" placeholder="Status" name="status" value="Opened">
                                    </div>
                                    <!--<div class="col-2">-->
                                    <!--<div class="rs-select2 js-select-simple select--no-search">-->
                                    <!--                                    <select name="status">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-2" type="number" placeholder="Salary" name="salary" required>
                                </div>
                            </div>
                            <div class="p-t-30">
