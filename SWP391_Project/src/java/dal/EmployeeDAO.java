...
public class EmployeeDAO extends DBContext {
    ...
    public ArrayList<Employee> getAdmin() throws SQLException {
        ArrayList<Employee> list = new ArrayList<>();

        String sql = "  select * from [Employee] e, Department d, [Certificate] c  where e.CertificateID = c.CertificateID and d.Did = e.Did";
        try {
            ...
            while (rs.next()) {
                Employee e = new Employee(rs.getInt(1), rs.getInt(2), rs.getString(3), rs.getInt(4), rs.getInt(5), rs.getString(6), rs.getString(7), rs.getString(8),
                        ...
                        rs.getDate(1), rs.getDate(1), rs.getString(1));
                Certificate c = new Certificate(rs.getInt(23), rs.getString(24));
                Department d = new Department(rs.getInt(25), rs.getString(26), rs.getString(27));
                e.setDepartment(d);
                e.setCertificate(c);
                list.add(e);
            }
    ...
    public Employee getEmployeeDetail(String eid) throws SQLException {
        ...
        String sql = "  select * from [Employee] e, Department d, [Certificate] c\n"
